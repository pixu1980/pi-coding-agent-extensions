...
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [008](008-make-the-pi-sessions-listing-cache-filesystem-free-with-explicit-invalidation.md) | Make the pi-sessions cached path filesystem-free and move freshness to an explicit invalidation contract.                                                                                                                       | Zero filesystem calls on the cached path (0.012 ms serve) and deterministic invalidation via `clearSessionsCache()` on `session_start`; a session file created mid-session is invisible until the 5-minute TTL expires.            |
