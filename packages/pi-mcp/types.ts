...
export interface McpSettings {
  ...
  /**
   * Number of direct tools at which point a console warning is emitted.
   * Defaults to 500. The original pi-mcp-adapter had this hardcoded at 75.
   */
  directToolsAdvisoryThreshold?: number;
  /**
